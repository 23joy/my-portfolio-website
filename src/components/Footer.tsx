    ...
    <footer className="px-6 py-12 lg:px-20 border-t border-white/10 bg-background-dark">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-black tracking-tighter uppercase">Joyshree Roy</span>
        </div>
        ...
        <p className="text-white/40 text-sm">© 2026 Joyshree Roy. ALL RIGHTS RESERVED.</p>
      </div>
    </footer>
  );
}
